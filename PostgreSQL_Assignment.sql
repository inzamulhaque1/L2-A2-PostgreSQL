...
-- View all tables data after operations
SELECT 'Rangers Table:' as table_info;
SELECT * FROM rangers;

SELECT 'Species Table:' as table_info;
SELECT * FROM species;

SELECT 'Sightings Table:' as table_info;
SELECT * FROM sightings;

-- Verify foreign key relationships
SELECT 'Sightings with Species and Rangers:' as verification;
SELECT s.sighting_id, sp.common_name, r.name, s.location, s.sighting_time
FROM sightings s
JOIN species sp ON s.species_id = sp.species_id
JOIN rangers r ON s.ranger_id = r.ranger_id
